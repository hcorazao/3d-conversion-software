...
export default class PrepMargin2CopyLineTransition extends Transition {
  constructor(appFacadeApi: AppFacadeApi, stateFactory: IStateFactory) {
    super(TransitionEnum.PrepMargin2CopyLine, StateEnum.PreparationMarginEntered, StateEnum.CopyLineCreated, appFacadeApi, stateFactory);
  }
