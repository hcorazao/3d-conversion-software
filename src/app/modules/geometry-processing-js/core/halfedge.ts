...
export default class Halfedge {
  public vertex: CRVertex;
  public edge: CREdge;
  public face: CRFace;
  public corner: CRCorner;
  public next: CRHalfEdge;
  public prev: CRHalfEdge;
  public twin: CRHalfEdge;
  public onBoundary: boolean;
  public index: number;
  ...
  dispose(mesh?: CRHalfEdgeMesh) {
    if (mesh) {
      mesh.halfedges[this.index] = undefined;
    }
